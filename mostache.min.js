...
return i===n&&r.cache.__OR&&(i=r.cache.__OR.concat(n).reduce(function(e,t,n){return(1===n?this.interpretRawValue(e,r):e)||this.interpretRawValue(t,r)}.bind(this))),i!==n?t.escape(i):void 0},h.prototype.rawValue=function(e){return e[1]},h.prototype.interpretRawValue=function(e,t){var r
return e===r?e:0===e.search(/^['"].*['"]$/)?e.substr(1,e.length-2):isNaN(e)?t.lookup(e):parseFloat(e)},t.name="mustache.js",t.version="2.1.3",t.tags=["{{","}}"]
var A=new h
